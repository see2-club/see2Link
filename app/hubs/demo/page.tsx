...
export default function Page() {
  return (
    <>
      <See2LinNavBar />
      <div className='mx-auto flex w-full flex-col flex-wrap items-center bg-neutral'>
        <UserInfo />
        {/* <div className='p-10'>
...
function UserInfo() {
  return (
    <div className='flex items-center justify-center  bg-gradient-to-br from-secondary to-secondary-content'>
      <div className='group relative mx-auto mt-24 w-full min-w-0 max-w-md break-words rounded-xl border bg-secondary text-secondary-content shadow-2xl  md:max-w-sm'>
        <div className='pb-6'>
            ...
            <div className='w-full text-center'>
              <div className='flex justify-center pb-0 pt-8 lg:pt-4'>
                <div className='flex space-x-2'>
                  ...
                  >
                    <svg
                      className='size-6 overflow-visible fill-current'
                      aria-hidden='true'
                      viewBox='0 0 140 140'
                      xmlns='http://www.w3.org/2000/svg'
                    >
