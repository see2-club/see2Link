...
function See2LinNavBar() {
  return (
    <>
      <div className='fixed z-50 flex h-16 w-full items-center bg-neutral-900'>
        <div className='mx-auto flex max-w-screen-xl flex-1 flex-col px-4 md:flex-row md:items-center md:justify-between md:px-6 lg:px-8'>
          <div className='flex flex-row items-center justify-between'>
            <Link
              href='#'
              className='dark-mode:text-white rounded-lg text-lg font-semibold uppercase tracking-widest text-gray-900 focus:shadow-none focus:outline-none'
            >
              <See2clubLogo />
            </Link>
            <div className='dropdown dropdown-end dropdown-bottom'>
              <div tabIndex={0} role='button' className='btn m-0 h-2 px-4'>
                Theme
                <svg
                  width='8px'
                  height='8px'
