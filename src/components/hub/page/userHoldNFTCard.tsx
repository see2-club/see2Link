        ...
        <div className="dropdown dropdown-end dropdown-top">
          <div className="flex space-x-1">
            <button className="btn btn-square btn-ghost" aria-label="button component">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="size-6 shrink-0 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="w-full flex-col px-2">
            <div className="flex flex-row justify-between px-2">
              <div className="join items-center justify-center gap-2">
                ...
                <svg className=' join-item w-4 md:w-8' viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
