...
function UserHoldCryptoCard({ data }) {
  const { NFTName, quantity, currentPrice, image } = data;
  ...
  return (
    ...
    <details className="collapse bg-base-200">
      <summary >
        <div className="flex w-full items-center rounded-box bg-secondary p-4 text-secondary-content shadow-xl">
...
const nfts = [
  { tokenId: 5678, name: 'NFT Name 1', imageUrl: 'https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg' },
  { tokenId: 5679, name: 'NFT Name 2', imageUrl: 'https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg' },
  { tokenId: 5678, name: 'NFT Name 1', imageUrl: 'https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg' },
  { tokenId: 5679, name: 'NFT Name 2', imageUrl: 'https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg' },
  // 更多的 NFTs...
];
